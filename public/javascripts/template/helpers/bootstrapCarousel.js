define('template/helpers/bootstrapCarousel', ['Handlebars'], function(Handlebars) {
  
  var bootstrapCarousel = function(items, options) {

    var start = '<div id="myCarousel" class="carousel slide">' +
                '<div class="carousel-nb">' + items.length + ' Images</div>';
    var end = '<a class="carousel-control left" href="#myCarousel" data-slide="prev">&lsaquo;</a>' +
